...
--hostname=10.52.122.146 >> /nfs/pdx/home/fboemer/repos/he-transformer/results/mobilenet_results/035_128_ram_test.txt;
...
# top=$(ps aux --sort=-%mem | awk 'NR<=2{print $0}' | tail -n 1 | tr -s ' ' | cut -d ' ' -f2); echo $top; psrecord $top --log server_ram_128.txt --plot server_ram_128.png --interval 1