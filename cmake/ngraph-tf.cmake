...
SET(NGRAPH_TF_VENV_LIB_DIR ${NGRAPH_TF_VENV_DIR}/lib/python3.5/site-packages/ngraph_bridge)

SET(NGRAPH_TEST_UTIL_INCLUDE_DIR ${NGRAPH_TF_BUILD_DIR}/ngraph/test)

message("NGRAPH_TF_SRC_DIR ${NGRAPH_TF_SRC_DIR}")

message("NGRAPH_TF_INCLUDE_DIR ${NGRAPH_TF_INCLUDE_DIR}")

message("CMAKEC ${CMAKE_BINARY_DIR}f")
...
ExternalProject_Add(
    ...
    INSTALL_COMMAND ln -s ${NGRAPH_TF_VENV_DIR} ${EXTERNAL_INSTALL_DIR}
)
