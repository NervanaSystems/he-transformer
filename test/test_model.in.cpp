...
TEST_F(TestHEBackend, tf_experiment_const_1)
{
    auto backend = runtime::Backend::create("CPU");
    const string json_path = file_util::path_join(HE_SERIALIZED_ZOO, "experiment_experiment_const_2_2_3.js");
    const string json_string = file_util::read_file_to_string(json_path);
    shared_ptr<Function> f = deserialize(json_string);

    // Visualize model
    auto model_file_name =
        "experiment_experiment_const_2_2_3" + string(".") + pass::VisualizeTree::get_file_ext();
