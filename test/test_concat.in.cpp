...
auto concat_test = [](const ngraph::Shape& shape_a, const ngraph::Shape& shape_b,
                      const ngraph::Shape& shape_c, size_t concat_axis,
                      const std::vector<float>& input_a,
                      const std::vector<float>& input_b,
                      const std::vector<float>& input_c, const std::vector<float>& output,
  ...
  auto c = std::make_shared<ngraph::op::Parameter>(ngraph::element::f32, shape_c);
  auto t = std::make_shared<ngraph::op::Concat>(ngraph::NodeVector{a, b, c}, concat_axis);
  auto f = std::make_shared<ngraph::Function>(t, ngraph::ParameterVector{a, b, c});
  ...
  auto t_b =
      ngraph::test::he::tensor_from_flags(*he_backend, shape_b, arg1_encrypted, packed);
  auto t_c =
      ngraph::test::he::tensor_from_flags(*he_backend, shape_c, arg1_encrypted, packed);
...
NGRAPH_TEST(${BACKEND_NAME}, concat_matrix_colwise_plain_real_unpacked) {
  concat_test(
      ngraph::Shape{2, 2}, ngraph::Shape{2, 3}, ngraph::Shape{2, 3}, 1, std::vector<float>{2, 4, 8, 16},
      std::vector<float>{1, 2, 4, 8, 16, 32}, std::vector<float>{2, 3, 5, 7, 11, 13},
      std::vector<float>{2, 4, 1, 2, 4, 2, 3, 5, 8, 16, 8, 16, 32, 7, 11, 13}, false,
      false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_matrix_colwise_cipher_real_unpacked) {
  concat_test(
      ngraph::Shape{2, 2}, ngraph::Shape{2, 3}, ngraph::Shape{2, 3}, 1, std::vector<float>{2, 4, 8, 16},
      std::vector<float>{1, 2, 4, 8, 16, 32}, std::vector<float>{2, 3, 5, 7, 11, 13},
      std::vector<float>{2, 4, 1, 2, 4, 2, 3, 5, 8, 16, 8, 16, 32, 7, 11, 13}, true,
      false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_matrix_rowise_plain_real_unpacked) {
  concat_test(
      ngraph::Shape{2, 2}, ngraph::Shape{3, 2}, ngraph::Shape{3, 2}, 0, std::vector<float>{2, 4, 8, 16},
      std::vector<float>{1, 2, 4, 8, 16, 32}, std::vector<float>{2, 3, 5, 7, 11, 13},
      std::vector<float>{2, 4, 8, 16, 1, 2, 4, 8, 16, 32, 2, 3, 5, 7, 11, 13}, false,
      false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_matrix_rowise_cipher_real_unpacked) {
  concat_test(
      ngraph::Shape{2, 2}, ngraph::Shape{3, 2}, ngraph::Shape{3, 2}, 0, std::vector<float>{2, 4, 8, 16},
      std::vector<float>{1, 2, 4, 8, 16, 32}, std::vector<float>{2, 3, 5, 7, 11, 13},
      std::vector<float>{2, 4, 8, 16, 1, 2, 4, 8, 16, 32, 2, 3, 5, 7, 11, 13}, true,
      false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_vector_plain_real_unpacked) {
  concat_test(ngraph::Shape{4}, ngraph::Shape{6}, ngraph::Shape{2}, 0, std::vector<float>{2, 4, 8, 16},
              std::vector<float>{1, 2, 4, 8, 16, 32}, std::vector<float>{18, 19},
              std::vector<float>{2, 4, 8, 16, 1, 2, 4, 8, 16, 32, 18, 19}, false,
              false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_4d_tensor_plain_real_unpacked) {
  concat_test(ngraph::Shape{1, 1, 1, 1}, ngraph::Shape{1, 1, 1, 1}, ngraph::Shape{1, 1, 1, 1}, 0,
              std::vector<float>{1}, std::vector<float>{2}, std::vector<float>{3},
...
NGRAPH_TEST(${BACKEND_NAME}, concat_2d_tensor_plain_real_unpacked) {
  concat_test(ngraph::Shape{1, 1}, ngraph::Shape{1, 1}, ngraph::Shape{1, 1}, 0, std::vector<float>{1},
              std::vector<float>{2}, std::vector<float>{3}, std::vector<float>{1, 2, 3}, false,
              false, false);
}
...
NGRAPH_TEST(${BACKEND_NAME}, concat_2d_tensor_cipher_real_unpacked) {
  concat_test(ngraph::Shape{1, 1}, ngraph::Shape{1, 1}, ngraph::Shape{1, 1}, 0, std::vector<float>{1},
              std::vector<float>{2}, std::vector<float>{3}, std::vector<float>{1, 2, 3}, true,
              false, false);
}
