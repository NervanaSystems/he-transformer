...
TEST(he_type, plain) {
  {
    ...
    EXPECT_TRUE(ngraph::test::he::all_close(plain, he_type.get_plaintext()));
...
TEST(he_type, cipher) {
  {
    ...
    bool complex_packing = false;
    auto cipher = ngraph::he::HESealBackend::create_empty_ciphertext();
    auto he_type = ngraph::he::HEType(cipher, complex_packing, batch_size);
    ...
    he_type.set_plaintext(ngraph::he::HEPlaintext());
