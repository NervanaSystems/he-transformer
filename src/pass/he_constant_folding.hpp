...
namespace ngraph {
namespace pass {
class HEConstantFolding;
}
}  // namespace ngraph

class ngraph::pass::HEConstantFolding : public ngraph::pass::GraphRewrite {
 public:
  ...
  HEConstantFolding() : GraphRewrite() {
  ...
  HEConstantFolding(const std::vector<CFTransformations>& transformations)
      : GraphRewrite() {
    for (auto cft : transformations) {
      switch (cft) {
        case CFTransformations::RESHAPE:
          construct_constant_reshape();
          break;
        case CFTransformations::BROADCAST:
          construct_constant_broadcast();
          break;
        case CFTransformations::PAD:
          construct_constant_pad();
          break;
        case CFTransformations::UNARY:
          construct_constant_unary();
          break;
        case CFTransformations::BINARY:
          construct_constant_binary();
          break;
        case CFTransformations::DEQUANTIZE:
          construct_constant_dequantize();
          break;
        case CFTransformations::QUANTIZE:
          construct_constant_quantize();
          break;
      }
    }
