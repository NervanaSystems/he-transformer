...
namespace he {
namespace kernel {
void scalar_multiply(std::shared_ptr<runtime::he::HECiphertext>& arg0,
...
void scalar_multiply(std::shared_ptr<runtime::he::HECiphertext>& arg0,
                     std::shared_ptr<runtime::he::HEPlaintext>& arg1,
                     std::shared_ptr<runtime::he::HECiphertext>& out,
                     const element::Type& element_type,
                     const runtime::he::HEBackend* he_backend);

void scalar_multiply(std::shared_ptr<runtime::he::HEPlaintext>& arg0,
                     std::shared_ptr<runtime::he::HECiphertext>& arg1,
                     std::shared_ptr<runtime::he::HECiphertext>& out,
                     const element::Type& element_type,
                     const runtime::he::HEBackend* he_backend);
...
void multiply(std::vector<std::shared_ptr<S>>& arg0,
