...
void runtime::he::kernel::convolution(
...
{
    convolution_template(arg0, arg1, out, arg0_shape, arg1_shape, out_shape, window_movement_strides, window_dilation_strides, padding_below, padding_above, data_dilation_strides, batch_axis_data, input_channel_axis_data, input_channel_axis_filters, output_channel_axis_filters, batch_axis_result, output_channel_axis_result, rotate_filter, type, he_backend);
}
...
void runtime::he::kernel::convolution(
        ...
        shared_ptr<runtime::he::HEBackend> he_backend)
{
    convolution(arg1, arg0, out, arg1_shape, arg0_shape, out_shape, window_movement_strides, window_dilation_strides, padding_below, padding_above, data_dilation_strides, batch_axis_data, input_channel_axis_data, input_channel_axis_filters, output_channel_axis_filters, batch_axis_result, output_channel_axis_result, rotate_filter, type, he_backend);
}
