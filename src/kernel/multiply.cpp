        ...
        if (arg0_seal && arg1_seal && out_seal)
        {
            ...
            if (type_name == "float")
            {
                ...
                auto seal_0_plaintext = static_pointer_cast<const he_seal::SealPlaintextWrapper>(
                                            ...
                                            ->m_plaintext;
                auto seal_1_plaintext = static_pointer_cast<const he_seal::SealPlaintextWrapper>(
                                            he_seal_backend->get_valued_plaintext(1))
                                            ->m_plaintext;
                auto seal_neg1_plaintext = static_pointer_cast<const he_seal::SealPlaintextWrapper>(
                                               he_seal_backend->get_valued_plaintext(-1))
                                               ->m_plaintext;
