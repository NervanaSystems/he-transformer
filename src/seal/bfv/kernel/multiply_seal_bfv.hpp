        ...
        namespace he
        {
            namespace he_seal
            {
                namespace bfv
                {
                    namespace kernel
                    {
                        void scalar_multiply_bfv(const shared_ptr<const he_seal::SealCiphertextWrapper>& arg0,
                        ...
                        void scalar_multiply_bfv(const shared_ptr<const he_seal::SealPlaintextWrapper>& arg0,
                                    const shared_ptr<const he_seal::SealCiphertextWrapper>& arg1,
                                    shared_ptr<he_seal::SealCiphertextWrapper>& out,
                                    const element::Type& element_type,
                                    const he_seal::HESealBFVBackend* he_seal_bfv_backend);
