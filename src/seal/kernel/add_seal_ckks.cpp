...
#include "seal/ckks/kernel/add_seal.hpp"
#include "seal/ckks/seal_util.hpp"
...
void ngraph::he::scalar_add(
  ...
  if (arg1.is_single_value()) {
    ...
    /* if (!arg1->is_encoded()) {
       ...
       // Shouldn't be needed?
       // match_modulus_inplace(arg0.get(), arg1.get(), he_seal_backend,
       // pool);
       match_scale(arg0.get(), arg1.get(), he_seal_backend);
     } */
