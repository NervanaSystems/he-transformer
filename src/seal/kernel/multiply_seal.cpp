...
void he_seal::kernel::scalar_multiply(HECiphertext* arg0, HECiphertext* arg1,
...
void he_seal::kernel::scalar_multiply(HECiphertext* arg0, HEPlaintext* arg1,
                                      shared_ptr<HECiphertext>& out,
                                      const element::Type& element_type,
                                      he_seal::HESealBackend* he_seal_backend,
                                      const seal::MemoryPoolHandle& pool) {
...
void he_seal::kernel::scalar_multiply(HEPlaintext* arg0, HECiphertext* arg1,
                                      shared_ptr<HECiphertext>& out,
                                      const element::Type& element_type,
                                      he_seal::HESealBackend* he_seal_backend,
                                      const seal::MemoryPoolHandle& pool) {
...
void he_seal::kernel::scalar_multiply(HEPlaintext* arg0, HEPlaintext* arg1,
