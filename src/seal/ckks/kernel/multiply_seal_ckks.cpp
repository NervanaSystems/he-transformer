...
void he_seal::ckks::kernel::scalar_multiply_ckks(const shared_ptr<const he_seal::SealCiphertextWrapper>& arg0,
                                      ...
                                      const runtime::he::he_seal::HESealCKKSBackend* he_seal_ckks_backend)
{
    ...
    {
        he_seal_ckks_backend->get_evaluator()->square(arg1->m_ciphertext, out->m_ciphertext);
    }
    else if (arg0 == out)
    {
        he_seal_ckks_backend->get_evaluator()->multiply_inplace(out->m_ciphertext, arg1->m_ciphertext);
    }
    else if (arg1 == out)
    {
        he_seal_ckks_backend->get_evaluator()->multiply_inplace(out->m_ciphertext, arg0->m_ciphertext);
    }
    else
    {
    ...
    he_seal_ckks_backend->get_evaluator()->relinearize_inplace(out->m_ciphertext,
                                                          *(he_seal_ckks_backend->get_relin_keys()));
                                      ...
                                      const runtime::he::he_seal::HESealCKKSBackend* he_seal_ckks_backend)
{
    ...
    if (arg0 == out)
    {
        he_seal_ckks_backend->get_evaluator()->multiply_plain_inplace(arg0_scaled->m_ciphertext,
...
void he_seal::ckks::kernel::scalar_multiply_ckks(const shared_ptr<const he_seal::SealPlaintextWrapper>& arg0,
                                      const shared_ptr<const he_seal::SealCiphertextWrapper>& arg1,
                                      shared_ptr<he_seal::SealCiphertextWrapper>& out,
                                      const element::Type& element_type,
                                      const runtime::he::he_seal::HESealCKKSBackend* he_seal_ckks_backend)
