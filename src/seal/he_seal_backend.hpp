...
class HESealBackend : public ngraph::runtime::Backend {
 ...
 private:
  ...
  std::unordered_set<std::string> m_unsupported_op_name_list{
      "Abs", "Acos", "All", "AllReduce", "And", "Any", "ArgMax", "ArgMin",
      "Asin", "Atan", "AvgPoolBackprop", "BatchMatMul",
      // "BatchNormTraining",
      "BatchNormTrainingBackprop", "BroadcastDistributed", "Ceiling", "Convert",
      "ConvolutionBackpropData", "ConvolutionBackpropFilters", "Cos", "Cosh",
      "Dequantize", "Divide", "DynBroadcast", "DynPad", "DynReshape",
      "DynSlice", "EmbeddingLookup", "Equal", "Erf", "Exp", "Floor", "Gather",
      "GatherND", "GenerateMask", "GetOutputElement", "Greater", "GreaterEq",
      "Less", "LessEq", "Log", "LRN", "Max", "Maximum", "MaxPoolBackprop",
      "Min", "Not", "NotEqual", "OneHot", "Or", "Power", "Product", "Quantize",
      "QuantizedAvgPool", "QuantizedConvolutionBias",
      "QuantizedConvolutionBiasAdd", "QuantizedConvolutionBiasSignedAdd",
      "QuantizedConvolutionRelu", "QuantizedConvolution", "QuantizedDot",
      "QuantizedDotBias", "QuantizedMaxPool", "Send", "Recv", "Range",
      "ReluBackprop", "ReplaceSlice", "ReverseSequence", "ScatterAdd",
      "ScatterNDAdd", "Select", "ShapeOf", "Sigmoid", "SigmoidBackprop", "Sign",
      "Sin", "Sinh", "Softmax", "Sqrt", "StopGradient", "Tan", "Tanh", "Tile",
      "TopK", "Transpose"};
};
