...
message("Installing ntl at GMP_PREFIX: ${NGRAPH_HE_INSTALL_INCLUDE_DIR}")
...
ExternalProject_Add(
    ...
    PREFIX ${NTL_PREFIX}
    CONFIGURE_COMMAND cd ${NTL_SOURCE_DIR}/src && ./configure NTL_GMP_LIP=on SHARED=on PREFIX=${NGRAPH_HE_INSTALL_DIR} GMP_PREFIX=${NGRAPH_HE_INSTALL_INCLUDE_DIR}
